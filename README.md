...
-   We live in a diverse planet with cultures that observe different working
    weeks, regardless of time zone. Israel for example, has a Sunday to Thursday
    working week.

-   Due to the international dateline, Monday in Auckland, is Sunday in Los
    Angeles. This means that there is 4 days of overlap during the working week
    on a time zone basis.
...
the top of the list for the other time zones when they come online.
...
Use calendar proposal tools for proposing dates for meetings. This also ensures
the data and time are defined explicitly.
